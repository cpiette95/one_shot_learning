...
function [data OrigIndex]= LoadBinary(FileName, ProjectName, Channels, varargin)
...
if FileExists([ProjectName '.xml']) || FileExists([ProjectName '.par'])
    Par = LoadPar([ProjectName]);
